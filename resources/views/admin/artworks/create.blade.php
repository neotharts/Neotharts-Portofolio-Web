    ...
    <div class="form-card glass-card">
        ...
        <form action="{{ route('admin.artworks.store') }}" method="POST" enctype="multipart/form-data" class="artwork-form">
            ...
            <div class="form-actions">
                ...
                <button type="submit" class="button button-primary artwork-submit-button" data-loading-text="Mengupload...">Simpan Artwork</button>
            </div>
        </form>
        ...
        <div class="upload-loading-overlay" id="uploadLoadingOverlay" role="status" aria-live="polite" aria-hidden="true">
            <div class="upload-loading-panel">
                ...
                <div>
                    <p class="upload-loading-title">Mengupload artwork</p>
                    <p class="upload-loading-text">Gambar sedang dikirim dan dikompres. Jangan tutup halaman ini.</p>
